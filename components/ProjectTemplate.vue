...
<template>
  <div class="project">
    <section class="hero" ref="heroSection">
      <div class="title">
        <h1 class="default-animate">Title</h1>
        <p class="default-animate">Description</p>
      </div>
      <img src="../assets/placeholder.jpg" alt="" class="default-animate" />
    </section>
    ...
    <main class="main-content">
      <section class="key-contributions">
        ...
        <div class="key-container" ref="KeyContributionsMotion">
          <div class="key-item">
            ...
            <p class="lighter">contributions</p>
          </div>
          <div class="key-item">
      ...
      <section class="prizes">
        ...
        <div class="prizes-container">
          <a href="#" target="_blank"><img src="../assets/placeholder-prize.png" alt="" /></a>
          <a href="#" target="_blank"><img src="../assets/placeholder-prize.png" alt="" /></a>
          <a href="#" target="_blank"><img src="../assets/placeholder-prize.png" alt="" /></a>
          <a href="#" target="_blank"><img src="../assets/placeholder-prize.png" alt="" /></a>
        </div>
      ...
      <section class="info-block">
        ...
        <div class="video-container">
          <iframe width="740" height="416" src="https://www.youtube.com/embed/tMlyMI7Zc4k?si=J_s9iM2fUUB2mR1e" frameborder="0" allowfullscreen title="Those I met in Patagonia"></iframe>
        </div>
      </section>
