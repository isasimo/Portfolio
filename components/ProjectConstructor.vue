    ...
    <main class="main-content">
      ...
      <section class="sticky-text-gallery">
        <div class="text-section">
          <h2>Grafari</h2>
          <p>
            Grafari guides children aged 6 and above through a spelling journey, from the introduction of letters and sounds to the basics of writing and typing. The goal during the training is to get the learner to a full focus mode, making elements on screen as clean and less distractive as possible. While exploring other sections of the app, learners engage in various activities such as
            listening to stories, purchasing items in the virtual shop, and tracking their progress.
          </p>
        </div>
